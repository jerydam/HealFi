...
contract MercuryRegistryTest is Test {
  ...
  string[] feedIds;
  string s_BTUSDTFeedId = "0x6962e629c3a0f5b7e3e9294b0c283c9b20f94f1c89c8ba8c1ee4650738f20fb2";
  ...
  bytes s_august22BTUSDTMercuryReport =
  ...
  bytes s_august23BTUSDTMercuryReport =
  ...
  bytes s_august23BTUSDTMercuryReport_2 =
  ...
  // Price: $1.00035464
  bytes s_august30USDUSDTMercuryReport =
  ...
  function testMercuryRegistry() public {
    ...
    values[0] = s_august22BTUSDTMercuryReport;
    ...
    uint32 oldObservationsTimestamp;
    {
      ...
      ) = s_testRegistry.s_feedMapping(s_BTUSDTFeedId);
      ...
      assertEq(localFeedId, s_BTUSDTFeedId);
    ...
    values = new bytes[](2);
    values[0] = s_august23BTUSDTMercuryReport;
    ...
    assertEq(feeds[0].feedId, s_BTUSDTFeedId);
    ...
    values = new bytes[](1);
    values[0] = s_august23BTUSDTMercuryReport_2;
    ...
    inactiveFeedReports[0] = s_august30USDUSDTMercuryReport;
