      ...
      <section className="bg-gradient-to-b from-green-50 to-white py-12 md:py-24">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl max-w-[900px]">
              Save for Health. Borrow with Ease.
            </h1>
            <p className="max-w-[700px] text-gray-600 text-sm sm:text-base md:text-xl">
      ...
      <section className="py-12 bg-white">
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8">
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white rounded-lg shadow-sm border border-gray-100">
              <div className="rounded-full bg-green-100 p-3 mb-4">
                <Wallet className="h-5 w-5 sm:h-6 sm:w-6 text-green-600" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold">500+</h3>
              <p className="text-gray-500 text-sm sm:text-base text-center">Total Savings (cUSD)</p>
            </div>
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white rounded-lg shadow-sm border border-gray-100">
              ...
              <p className="text-gray-500 text-sm sm:text-base text-center">Loans Provided</p>
            </div>
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white rounded-lg shadow-sm border border-gray-100">
              <div className="rounded-full bg-blue-100 p-3 mb-4">
                <Users className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold">1,000+</h3>
              <p className="text-gray-500 text-sm sm:text-base text-center">Community Members</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-24 bg-gray-50">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tighter">How HealFi Works</h2>
            <p className="max-w-[700px] text-gray-600 text-sm sm:text-base">
              Our platform makes healthcare financing accessible to everyone through simple savings and microloans.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white rounded-lg shadow-sm">
              <div className="rounded-full bg-green-100 p-3 sm:p-4 mb-4">
                <Wallet className="h-6 w-6 sm:h-8 sm:w-8 text-green-600" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold mb-2">Save</h3>
              <p className="text-center text-gray-600 text-sm sm:text-base">
                Set aside small amounts regularly to build your healthcare fund and earn interest.
              </p>
            </div>
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white rounded-lg shadow-sm">
              <div className="rounded-full bg-orange-100 p-3 sm:p-4 mb-4">
                <CreditCard className="h-6 w-6 sm:h-8 sm:w-8 text-orange-600" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold mb-2">Borrow</h3>
              <p className="text-center text-gray-600 text-sm sm:text-base">
            ...
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white rounded-lg shadow-sm">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2">Heal</h3>
              <p className="text-center text-gray-600 text-sm sm:text-base">
